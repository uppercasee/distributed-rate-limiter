...
const (
	RateLimiterService_Check_FullMethodName = "/limiter.RateLimiterService/Check"
)
...
func (c *rateLimiterServiceClient) Check(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (*CheckResponse, error) {
...
func (UnimplementedRateLimiterServiceServer) Check(context.Context, *CheckRequest) (*CheckResponse, error) {
...
func _RateLimiterService_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RateLimiterServiceServer).Check(ctx, req.(*CheckRequest))
	}
